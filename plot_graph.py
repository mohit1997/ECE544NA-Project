...
for cell in ['SimpleRNN', 'LSTM', 'GRU']:
	plt.plot(result_dic[cell]['sparse_categorical_accuracy'], label="{} train".format(cell), marker='o')
	plt.plot(result_dic[cell]['val_sparse_categorical_accuracy'], label="{} val".format(cell), marker='v')
...
for cell in ['SimpleRNN', 'LSTM', 'GRU']:
	plt.plot(result_dic[cell]['loss'], label="{} train".format(cell), marker='o')
	plt.plot(result_dic[cell]['val_loss'], label="{} val".format(cell), marker='v')
